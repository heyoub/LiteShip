...
[czap](../../../README.md) / [core/src](../README.md) / Cell

# Variable: Cell

> `const` **Cell**: `object`

Defined in: [core/src/cell.ts:116](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/core/src/cell.ts#L116)
