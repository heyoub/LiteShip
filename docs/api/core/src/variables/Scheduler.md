...
[czap](../../../README.md) / [core/src](../README.md) / Scheduler

# Variable: Scheduler

> `const` **Scheduler**: `object`

Defined in: [core/src/scheduler.ts:143](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/core/src/scheduler.ts#L143)
