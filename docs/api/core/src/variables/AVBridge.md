...
[czap](../../../README.md) / [core/src](../README.md) / AVBridge

# Variable: AVBridge

> `const` **AVBridge**: `object`

Defined in: [core/src/av-bridge.ts:154](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/core/src/av-bridge.ts#L154)
