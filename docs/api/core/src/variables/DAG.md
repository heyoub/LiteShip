...
[czap](../../../README.md) / [core/src](../README.md) / DAG

# Variable: DAG

> `const` **DAG**: `object`

Defined in: [core/src/dag.ts:500](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/core/src/dag.ts#L500)
