...
[czap](../../../README.md) / [core/src](../README.md) / Signal

# Variable: Signal

> `const` **Signal**: `object`

Defined in: [core/src/signal.ts:336](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/core/src/signal.ts#L336)
