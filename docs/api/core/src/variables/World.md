...
[czap](../../../README.md) / [core/src](../README.md) / World

# Variable: World

> `const` **World**: `object`

Defined in: [core/src/ecs.ts:360](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/core/src/ecs.ts#L360)
