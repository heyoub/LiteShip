...
[czap](../../../README.md) / [core/src](../README.md) / Diagnostics

# Variable: Diagnostics

> `const` **Diagnostics**: `object`

Defined in: [core/src/diagnostics.ts:158](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/core/src/diagnostics.ts#L158)
