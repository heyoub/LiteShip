...
[czap](../../../README.md) / [core/src](../README.md) / ChainValidationError
...
Defined in: [core/src/receipt.ts:36](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/core/src/receipt.ts#L36)
