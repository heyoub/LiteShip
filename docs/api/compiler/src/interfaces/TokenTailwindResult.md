...
[czap](../../../README.md) / [compiler/src](../README.md) / TokenTailwindResult

# Interface: TokenTailwindResult

Defined in: [compiler/src/token-tailwind.ts:24](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/compiler/src/token-tailwind.ts#L24)
...
Defined in: [compiler/src/token-tailwind.ts:26](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/compiler/src/token-tailwind.ts#L26)
