...
[czap](../../../README.md) / [compiler/src](../README.md) / CompilerDef
...
Defined in: [compiler/src/dispatch.ts:78](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/compiler/src/dispatch.ts#L78)
