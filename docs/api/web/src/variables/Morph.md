...
[czap](../../../README.md) / [web/src](../README.md) / Morph

# Variable: Morph

> `const` **Morph**: `object`

Defined in: [web/src/morph/diff.ts:138](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/web/src/morph/diff.ts#L138)
