...
[czap](../../../README.md) / [web/src](../README.md) / Physical

# Variable: Physical

> `const` **Physical**: `object`

Defined in: [web/src/index.ts:79](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/web/src/index.ts#L79)
