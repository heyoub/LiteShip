...
[czap](../../../README.md) / [web/src](../README.md) / Hints

# Variable: Hints

> `const` **Hints**: `object`

Defined in: [web/src/morph/hints.ts:279](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/web/src/morph/hints.ts#L279)
