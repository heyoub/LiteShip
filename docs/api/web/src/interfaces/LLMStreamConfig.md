...
Defined in: [web/src/stream/llm-adapter.ts:41](https://github.com/heyoub/LiteShip/blob/main/packages/web/src/stream/llm-adapter.ts#L41)
...
Defined in: [web/src/stream/llm-adapter.ts:45](https://github.com/heyoub/LiteShip/blob/main/packages/web/src/stream/llm-adapter.ts#L45)
...
Defined in: [web/src/stream/llm-adapter.ts:43](https://github.com/heyoub/LiteShip/blob/main/packages/web/src/stream/llm-adapter.ts#L43)
