...
[czap](../../../README.md) / [web/src](../README.md) / isPrivateOrReservedIP

# Function: isPrivateOrReservedIP()

> **isPrivateOrReservedIP**(`hostname`): `boolean`

Defined in: [web/src/security/runtime-url.ts:187](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/web/src/security/runtime-url.ts#L187)
