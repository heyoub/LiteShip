...
Defined in: [scene/src/compile.ts:27](https://github.com/heyoub/LiteShip/blob/main/packages/scene/src/compile.ts#L27)
...
Defined in: [scene/src/compile.ts:31](https://github.com/heyoub/LiteShip/blob/main/packages/scene/src/compile.ts#L31)
...
Defined in: [scene/src/compile.ts:29](https://github.com/heyoub/LiteShip/blob/main/packages/scene/src/compile.ts#L29)
