...
[czap](../../../README.md) / [scene/src](../README.md) / Layout

# Variable: Layout

> `const` **Layout**: `object`

Defined in: [scene/src/sugar/layout.ts:20](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/scene/src/sugar/layout.ts#L20)
