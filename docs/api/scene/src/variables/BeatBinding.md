...
[czap](../../../README.md) / [scene/src](../README.md) / BeatBinding

# Variable: BeatBinding

> `const` **BeatBinding**: `object`

Defined in: [scene/src/capsules/beat-binding.ts:117](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/scene/src/capsules/beat-binding.ts#L117)
