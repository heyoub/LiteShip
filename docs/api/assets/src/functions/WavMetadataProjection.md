...
Defined in: [assets/src/analysis/wav-metadata.ts:75](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/assets/src/analysis/wav-metadata.ts#L75)
