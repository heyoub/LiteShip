...
[czap](../../../README.md) / [quantizer/src](../README.md) / evaluate

# Function: evaluate()

> **evaluate**\<`B`\>(`boundary`, `value`, `previousState?`): [`EvaluateResult`](../interfaces/EvaluateResult.md)\<`StateUnion`\<`B`\>\>

Defined in: [quantizer/src/evaluate.ts:55](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/quantizer/src/evaluate.ts#L55)
