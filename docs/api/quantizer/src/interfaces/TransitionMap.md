...
Defined in: [quantizer/src/transition.ts:32](https://github.com/heyoub/LiteShip/blob/main/packages/quantizer/src/transition.ts#L32)
...
Defined in: [quantizer/src/transition.ts:34](https://github.com/heyoub/LiteShip/blob/main/packages/quantizer/src/transition.ts#L34)
