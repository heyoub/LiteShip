...
[czap](../../../README.md) / [worker/src](../README.md) / WorkerHostShape

# Interface: WorkerHostShape

Defined in: [worker/src/host.ts:31](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/worker/src/host.ts#L31)
...
Defined in: [worker/src/host.ts:33](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/worker/src/host.ts#L33)
...
Defined in: [worker/src/host.ts:36](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/worker/src/host.ts#L36)
...
Defined in: [worker/src/host.ts:48](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/worker/src/host.ts#L48)
...
Defined in: [worker/src/host.ts:63](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/worker/src/host.ts#L63)
...
Defined in: [worker/src/host.ts:60](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/worker/src/host.ts#L60)
...
Defined in: [worker/src/host.ts:51](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/worker/src/host.ts#L51)
...
Defined in: [worker/src/host.ts:54](https://github.com/TheFreeBatteryFactory/czap/blob/main/packages/worker/src/host.ts#L54)
