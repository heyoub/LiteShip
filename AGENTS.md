...
[CLAUDE.md](./CLAUDE.md) — repo conventions, command list, architecture
patterns, source-of-truth docs.

**Read [CLAUDE.md](./CLAUDE.md) for the full context.** Keeping a single
canonical document avoids drift between two near-identical guides.
